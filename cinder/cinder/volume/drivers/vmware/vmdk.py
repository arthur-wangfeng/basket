...
class VMwareEsxVmdkDriver(driver.VolumeDriver):
    ...
    def copy_volume_to_image(self, context, volume, image_service, image_meta):
        ...
        old_task_state = self._update_vm_task_state(context, volume, vcenter_task_states.EXPORTING)
        ...
        self._update_vm_task_state(context, volume, old_task_state)
    ...
    def _update_vm_task_state(self, context, volume, task_state):
        
        return self.nova.update_server_task_state(context,volume,task_state)
